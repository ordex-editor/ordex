...
- Automatic insert-mode completion with case-insensitive buffer-word suggestions plus background file-path suggestions for `/`, `./`, `../`, and `~/`, with live preview and Up/Down no-selection cancellation
